...
import { LayoutDashboard, BarChart2, Users, Settings, Component, ChevronLeft, TowerControl, DatabaseZap, ShieldCheck, Server, LineChart, Code, FileJson, Zap, Database, Trash2 } from "lucide-react";
...
const menuItems = [
  ...
  {
    label: "Clear Invalid Requests",
    href: "/clear-invalid-requests",
    icon: Trash2,
  },
  {
    label: "Analytics",
  ...
  {
    label: "Migration Decoder",
    href: "/migration-decoder",
    icon: Code,
  },
  {
